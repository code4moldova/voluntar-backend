...
def updateBeneficiary(requestjson, beneficiary_id, delete=False):
        ...
        try:
            ...
            elif 'set__volunteer' in update and requestjson['volunteer'] != '' and requestjson['volunteer'] is not None  and ('volunteer' not in data or  update['set__volunteer'] != data['volunteer']):
